...
TARGET_KERNEL_CONFIG := followmsi-aosp_defconfig
...
BOARD_CACHEIMAGE_PARTITION_SIZE := 587202560 # 560M (STOCK)
#BOARD_CACHEIMAGE_PARTITION_SIZE := 157286400 # 150M
#BOARD_CACHEIMAGE_PARTITION_SIZE := 33554432 # 32MB (AOSP)
